...
class CMT(nn.Module):
    def __init__(self, img_size = 224, in_chans = config.In_Channels, num_classes = config.Num_Classes, embed_dims = [46, 92, 184, 368],
                 stem_channel = 16, fc_dim = 1280,
        ...
        self.head = nn.Linear(fc_dim, 10) if num_classes > 0 else nn.Identity()
